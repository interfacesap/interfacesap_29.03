...
class TransacaoSucata(models.Model):
    ...
    idtipoOrdemFK = models.ForeignKey(tipoOrdem, related_name="tipo_ordem", blank=True, null=True, on_delete=models.CASCADE)
    idPrioridadeFK = models.ForeignKey(prioridade, related_name="prioridade", blank=True, null=True, on_delete=models.CASCADE)
    idLocalFK = models.ForeignKey(localInstal, related_name="localInstal", blank=True, null=True, on_delete=models.CASCADE)
    idtipoavtFK = models.ForeignKey(tipoAtv, related_name="tipoAtv", blank=True, null=True, on_delete=models.CASCADE)
    idCenTrabFK = models.ForeignKey(CentralTrab, related_name="CentralTrab", blank=True, null=True, on_delete=models.CASCADE)
    iddivisaoFK = models.ForeignKey(divisao, related_name="divisao", blank=True, null=True, on_delete=models.CASCADE)
    idCentroCustoFK = models.ForeignKey(centroCusto, related_name="centroCusto", blank=True, null=True, on_delete=models.CASCADE)
